...
export function CommonTrustedBrands() {
  const clients: ClientLogo[] = [
    {
      name: "Agro Grow",
      logo: "/bst-clients/agro-grow.svg",
    },
    {
      name: "Balisira Resort",
      logo: "/bst-clients/balisira-resort.png",
    },
    {
      name: "Fresh Meat Fish",
      logo: "/bst-clients/fresh-meat-fish.svg",
    },
    {
      name: "Larky Parky",
      logo: "/bst-clients/larky-parky.svg",
      width: 260,
    },
    {
      name: "Mahbub Perfume",
      logo: "/bst-clients/mahbub-perfume.svg",
    },
    {
      name: "Novem Eco Resort",
      logo: "/bst-clients/novem-eco-resort.svg",
    },
    {
      name: "Chandpur Roofing",
      logo: "/bst-clients/chandpur-roofing.svg",
    },
  ];
