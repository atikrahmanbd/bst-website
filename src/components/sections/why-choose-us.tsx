...
export function WhyChooseUs() {
  return (
    <section className="relative w-full pt-0 pb-40 bg-background overflow-hidden">
      <div className="mx-auto max-w-7xl relative z-10">
        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4 text-center max-w-7xl mx-auto px-4 md:px-8">
          ...
          <GlassContainer className="group">
            <GlowingEffect disabled={false} proximity={200} spread={30} />
            <div className="p-4">
              <div className="mb-4 inline-flex items-center justify-center w-12 h-12 rounded-lg bg-purple-500/10 group-hover:bg-purple-500/20 transition-colors">
          ...
          <GlassContainer className="group">
            <GlowingEffect disabled={false} proximity={200} spread={30} />
            <div className="p-4">
              <div className="mb-4 inline-flex items-center justify-center w-12 h-12 rounded-lg bg-sky-500/10 group-hover:bg-sky-500/20 transition-colors">
          ...
          <GlassContainer className="group">
            <GlowingEffect disabled={false} proximity={200} spread={30} />
            <div className="p-4">
              <div className="mb-4 inline-flex items-center justify-center w-12 h-12 rounded-lg bg-yellow-500/10 group-hover:bg-yellow-500/20 transition-colors">
          ...
          <GlassContainer className="group">
            <GlowingEffect disabled={false} proximity={200} spread={30} />
            <div className="p-4">
              <div className="mb-4 inline-flex items-center justify-center w-12 h-12 rounded-lg bg-green-500/10 group-hover:bg-green-500/20 transition-colors">
          ...
          <GlassContainer className="group">
            <GlowingEffect disabled={false} proximity={200} spread={30} />
            <div className="p-4">
              <div className="mb-4 inline-flex items-center justify-center w-12 h-12 rounded-lg bg-indigo-500/10 group-hover:bg-indigo-500/20 transition-colors">
          ...
          <GlassContainer className="group">
            <GlowingEffect disabled={false} proximity={200} spread={30} />
            <div className="p-4">
              <div className="mb-4 inline-flex items-center justify-center w-12 h-12 rounded-lg bg-orange-500/10 group-hover:bg-orange-500/20 transition-colors">
                <Rocket className="w-6 h-6 text-orange-500" />
              </div>
              <h3 className="mb-2 text-lg font-semibold">Scalability</h3>
              <p className="text-sm text-muted-foreground">
          ...
          <GlassContainer className="group">
            <GlowingEffect disabled={false} proximity={200} spread={30} />
            <div className="p-4">
              <div className="mb-4 inline-flex items-center justify-center w-12 h-12 rounded-lg bg-pink-500/10 group-hover:bg-pink-500/20 transition-colors">
                <HeartHandshake className="w-6 h-6 text-pink-500" />
              </div>
              <h3 className="mb-2 text-lg font-semibold">Partnership</h3>
              <p className="text-sm text-muted-foreground">
