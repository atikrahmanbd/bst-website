...
export const items = [
  ...
  // -------------------------------------
  {
    ...
    faqs: [
      ...
      {
        title: "Can I Transfer My Domain To B.S.T.?",
        content:
          "Yes. You Can Transfer Any Supported Domain To B.S.T. Simply Unlock The Domain, Obtain The EPP Code, and Start The Transfer From Your Dashboard.",
      },
      {
