...
export const items = [
  ...
  // -------------------------------------
  {
    ...
    faqs: [
      {
        title: "How Do I Transfer My Domain To B.S.T.?",
        content:
          "First, Unlock Your Domain At Your Current Registrar, Obtain The EPP/Auth Code, Then Initiate The Transfer From Your B.S.T. Dashboard By Entering The Domain Name and Auth Code.",
      },
      {
