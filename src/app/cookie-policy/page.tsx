                ...
                <div className="space-y-8 max-w-4xl mx-auto">
                  ...
                  <section id="types-of-cookies">
                    ...
                    <div className="mb-6">
                      ...
                      <div className="p-4 rounded-lg bg-muted/50 border border-border mt-3">
                        <p className="text-sm text-foreground">
                          <strong>Examples:</strong> Google Analytics, Page
                          Load Time Tracking
                        </p>
                        <p className="text-sm text-foreground mt-2">
                  ...
                  <section id="third-party-cookies">
                    ...
                    <p className="text-muted-foreground leading-relaxed text-justify mt-4">
                      ...
                      Cookie Policies. We Recommend Reviewing Their Policies
                  ...
                  <section id="do-not-track">
                    ...
                    <p className="text-muted-foreground leading-relaxed text-justify">
                      ...
                      Feature That Signals To Websites That You Do Not Want
                      Your Online Activity Tracked. Currently, There Is No
                      Industry Standard For Responding To DNT Signals. We Do
